...
import fetchHotelsByCountryId from "../../hook/fetchHotelsByCountryId";

const HotelSearch = ({ route, navigation }) => {
  const countryById = route.params;

  const { hotelByCountryId, isLoading, error, refetch } =
    fetchHotelsByCountryId(countryById._id, "all");
  ...
  return (
    <SafeAreaView style={{ flex: 1 }}>
      ...
      {hotelByCountryId && hotelByCountryId.length === 0 ? (
        <View>
